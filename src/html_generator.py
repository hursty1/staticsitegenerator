...
def generate_page(from_path, template_path, dest_path, base_path):
    ...
    template_contents_html = template_contents_html.replace(f'href="/', f'href="{base_path}')
    template_contents_html = template_contents_html.replace(f'src="/', f'src="{base_path}')
...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path, base_path):
    for item in os.listdir(dir_path_content):
        ...
        if os.path.isdir(src_path):
            ...
            if ext == '.md':
                generate_page(src_path, template_path, dest_path.replace('.md', '.html'), base_path)
            else:
